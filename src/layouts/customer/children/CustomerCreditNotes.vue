<template>
    <div class="card border-0">
        <div class="card-header border-0 bg-white">
            <div class="row">
                <div class="col-md-12">
                    <div class="alert py-1 my-1 alert-warning" role="alert">
                        $0.00 kullanılabilir krediler.
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="btn-list">
    ...
    data() {
        return {
            ...
            headers: [
                ...
                { text: 'Kredi Notu Tarihi', value: '2' },
                { text: 'Durum', value: '3' },
                { text: 'Proje', value: '4' },
                { text: 'Referans#', value: '5' },
                { text: 'Miktar', value: '6' },
                { text: 'Kalan Miktar', value: '7' },
